...
class DataGenerator:
    """Generate synthetic structured and unstructured data"""
    ...
    def generate_structured_data(self, rows: int = 1000, columns: int = 10) -> pd.DataFrame:
        """
        Generate structured data with numerical and categorical columns
        
        Args:
            rows: Number of rows to generate
            columns: Number of columns (will be 10 with specific types)
    ...
    def generate_unstructured_data(self, rows: int = 1000, columns: int = 5) -> pd.DataFrame:
        """
        Generate unstructured text data
        
        Args:
            rows: Number of rows to generate
            columns: Number of text columns (will be 5)
        
        Returns:
            DataFrame with unstructured text data
        """
        data = {
            'id': range(1, rows + 1),
    ...
    def _generate_ticket(self) -> str:
        """Generate support ticket descriptions"""
        issues = [
    ...
    def save_to_excel(self, structured_df: pd.DataFrame, 
        ...
        Args:
            ...
            unstructured_df: Optional DataFrame with unstructured data
